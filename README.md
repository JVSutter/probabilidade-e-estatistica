...
A seguinte tabela lista todos os exercícios completados durante o curso, em ordem de data de entrega. As tarefas em grupo foram realizadas por [Breno da Silva Pereira](https://github.com/BrenoSPXx/), [Caio César Rodrigues de Aquino](https://github.com/ligggght/), [João Vitor Curcio Sutter](https://github.com/JVSutter), [Luan da Silva Moraes](https://github.com/Luuls) e [Pedro Artur de Aguiar Cabral](https://github.com/pedroaaaaaaaaaa).
